...
class builtin_encn_Collins {
    ...
    async findCollins(word) {
        ...
        let audio = `https://dict.youdao.com/dictvoice?audio=${encodeURIComponent(expression)}&type=1`;
	let extrainfo = `https://dict.youdao.com/dictvoice?audio=${encodeURIComponent(expression)}&type=2`;
